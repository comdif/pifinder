...
FOR /F "delims=" %%s IN ('"arp -a|findstr d8-3a-dd"') DO SET result2=%%s
FOR /F "delims=" %%t IN ('"arp -a|findstr b8-27-eb"') DO SET result3=%%t
FOR /F "delims=" %%u IN ('"arp -a|findstr dc-a6-32"') DO SET result4=%%u
FOR /F "delims=" %%v IN ('"arp -a|findstr e4-5f-01"') DO SET result5=%%v
